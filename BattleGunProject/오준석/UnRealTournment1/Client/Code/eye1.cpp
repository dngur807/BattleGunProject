...
CEye1::CEye1(Engine::MYGDI* pMyGDI)
...
HRESULT CEye1::Initialize(void)
{
	...
	//m_pInfo->m_vPos = XMFLOAT3(-0.014f, -0.18f, 0.f);
	m_pInfo->m_vPos = XMFLOAT3(0.f, -0.5f, 0.f);
	//m_pInfo->m_vScale = XMFLOAT3(0.1f,0.02f, 1.f);
	m_pInfo->m_vScale = XMFLOAT3(0.5f, 0.5f, 0.5f);
...
void CEye1::Release(void)
{

}

int CEye1::Update(void)
{
...
HRESULT CEye1::AddComponent(void)
{
...
CEye1* CEye1::Create(Engine::MYGDI* pMyGDI)
{
	CEye1*		pGameObject = new CEye1(pMyGDI);
