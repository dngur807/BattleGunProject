...
int CPlayerUI3::Update(void)
{
	...
	if (Engine::Get_Input()->GetDIKeyState(DIK_CAPSLOCK))
	{
		BUTON77 = true;
	}
	else
	...
	if (Engine::Get_Input()->GetDIKeyState(DIK_1)&& m_bMenu==true)
	{
		BUTON5 = true;
	}
	else
	...
	if (Engine::Get_Input()->GetDIKeyState(DIK_2) && m_bMenu == true)
	{
		BUTON6 = true;
	}
	else
	...
	if (Engine::Get_Input()->GetDIKeyState(DIK_3) && m_bMenu == true)
	{
		BUTON7 = true;
	}
	else
	...
	if (Engine::Get_Input()->GetDIKeyState(DIK_4) && m_bMenu == true)
	{
		BUTON8 = true;
	}
	else
	...
	if (Engine::Get_Input()->GetDIKeyState(DIK_5) && m_bMenu == true)
	{
		BUTON9 = true;
	}
	else
