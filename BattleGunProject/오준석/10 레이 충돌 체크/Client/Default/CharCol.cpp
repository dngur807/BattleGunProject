...
void CCharCol::Initialize(Engine::CDynamicMesh* pCharMesh)
{
	...
	m_pSphere[0] = Engine::CSphereTex::Create(m_pMyGDI, 2.0f, 1);
	m_pSphere[1] = Engine::CSphereTex::Create(m_pMyGDI, 1.5f, 1);
	m_pSphere[2] = Engine::CSphereTex::Create(m_pMyGDI, 1.5f, 1);
	m_pSphere[3] = Engine::CSphereTex::Create(m_pMyGDI, 1.5f, 1);
	m_pSphere[4] = Engine::CSphereTex::Create(m_pMyGDI, 1.5f, 1);
	m_pSphere[5] = Engine::CSphereTex::Create(m_pMyGDI, 1.2f, 1);
	m_pSphere[6] = Engine::CSphereTex::Create(m_pMyGDI, 1.2f, 1);
	m_pSphere[7] = Engine::CSphereTex::Create(m_pMyGDI, 1.2f, 1);
	m_pSphere[8] = Engine::CSphereTex::Create(m_pMyGDI, 1.2f, 1);
	m_pSphere[9] = Engine::CSphereTex::Create(m_pMyGDI, 1.2f, 1);
	m_pSphere[10] = Engine::CSphereTex::Create(m_pMyGDI, 1.2f, 1);


	m_pSphere[11] = Engine::CSphereTex::Create(m_pMyGDI, 1.2f, 1);
	m_pSphere[12] = Engine::CSphereTex::Create(m_pMyGDI, 1.2f, 1);
	m_pSphere[13] = Engine::CSphereTex::Create(m_pMyGDI, 1.2f, 1);
	m_pSphere[14] = Engine::CSphereTex::Create(m_pMyGDI, 1.2f, 1);
	m_pSphere[15] = Engine::CSphereTex::Create(m_pMyGDI, 1.2f, 1);
