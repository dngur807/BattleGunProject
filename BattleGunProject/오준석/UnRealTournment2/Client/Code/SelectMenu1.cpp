...
CSelectMenu1::CSelectMenu1(Engine::MYGDI* pMyGDI)
...
CSelectMenu1::~CSelectMenu1(void)
{

}

HRESULT CSelectMenu1::Initialize(void)
{
	...
	m_pInfo->m_vPos = XMFLOAT3(0.f, 0.35f, 0.f);
...
void CSelectMenu1::Release(void)
{

}

int CSelectMenu1::Update(void)
{



	//cout << m_bMouseOn << endl;
...
HRESULT CSelectMenu1::AddComponent(void)
{
...
CSelectMenu1* CSelectMenu1::Create(Engine::MYGDI* pMyGDI)
{
	CSelectMenu1*		pGameObject = new CSelectMenu1(pMyGDI);
