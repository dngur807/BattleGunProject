...
CSelectMenu::CSelectMenu(Engine::MYGDI* pMyGDI)
...
HRESULT CSelectMenu::Initialize(void)
{
	...
	m_pInfo->m_vPos = XMFLOAT3(-0.65f, 0.7f, 0.1f);
	//m_pInfo->m_vScale = XMFLOAT3(0.1f,0.02f, 1.f);
	m_pInfo->m_vScale = XMFLOAT3(0.4f, 1.2f, 0.7f);
...
void CSelectMenu::Release(void)
{

}

int CSelectMenu::Update(void)
{
...
HRESULT CSelectMenu::AddComponent(void)
{
...
CSelectMenu* CSelectMenu::Create(Engine::MYGDI* pMyGDI)
{
	CSelectMenu*		pGameObject = new CSelectMenu(pMyGDI);
