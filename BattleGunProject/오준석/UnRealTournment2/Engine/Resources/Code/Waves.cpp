...
UINT Engine::Waves::RowCount()const
{
	return mNumRows;
}

UINT Engine::Waves::ColumnCount()const
{
	return mNumCols;
}

UINT Engine::Waves::VertexCount()const
{
	return mVertexCount;
}

UINT Engine::Waves::TriangleCount()const
{
	return mTriangleCount;
}
float Engine::Waves::Width()const
{
	return mNumCols*mSpatialStep;
}

float Engine::Waves::Depth()const
{
	return mNumRows*mSpatialStep;
}
void Engine::Waves::Init(UINT m, UINT n, float dx, float dt, float speed, float damping)
{
	mNumRows  = m;
	mNumCols  = n;
...
void Engine::Waves::Update(float dt)
{
	static float t = 0;
...
void Engine::Waves::Disturb(UINT i, UINT j, float magnitude)
{
