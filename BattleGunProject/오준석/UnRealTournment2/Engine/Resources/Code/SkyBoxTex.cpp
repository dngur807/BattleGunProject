...
Engine::CSkyBoxTex::CSkyBoxTex(MYGDI * pMyGDI)
	:CVIBuffer(pMyGDI)
{
...
Engine::CSkyBoxTex::~CSkyBoxTex()
{
}

HRESULT Engine::CSkyBoxTex::CreateBuffer(void)
{
...
Engine::CResources * Engine::CSkyBoxTex::CloneResource(void)
{
	++m_dwRefCnt;

	CResources* pResources = new CSkyBoxTex(*this);

	return pResources;
}

Engine::CSkyBoxTex * Engine::CSkyBoxTex::Create(MYGDI * pMyGDI)
{
	CSkyBoxTex* pBuffer = new CSkyBoxTex(pMyGDI);
