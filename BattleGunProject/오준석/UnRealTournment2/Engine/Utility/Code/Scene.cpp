...
//const Engine::CComponent* Engine::CScene::GetComponent(WORD LayerID, const wstring& wstrObject, const wstring& wstrComponentKey)
//{
//	MAPLAYER::iterator	iter = m_mapLayer.find(LayerID);
//	if (iter == m_mapLayer.end())
//		return NULL;
//
//	return iter->second->GetComponent(wstrObject, wstrComponentKey);
//}
