...
//const Engine::CComponent* Engine::CManagement::GetLayerComponent(WORD LayerID, const wstring& wstrObject, const wstring& wstrComponentKey)
//{
//	return m_pScene->GetComponent(LayerID, wstrObject, wstrComponentKey);
//}