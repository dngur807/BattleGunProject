...
HRESULT CStage::Add_GameLogic_Layer(void)
{
	...
	//const Engine::CComponent*	pRealPlayer = NULL;
	//pRealPlayer = const_cast<Engine::CComponent*>(m_pTargetPlayer);
...
HRESULT CStage::Add_UI_Layer(void)
{
	...
	pGameObject = CDynamicCamera::Create(m_pMyGDI, &pEye, &pAt, (const Engine::CTransform*) m_pTargetPlayer);
